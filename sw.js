...
var CACHE_NAME = 'scanner-shell-v29'; // v25 -> v26: status banner redesign (full-width instead of shrink-to-fit, flatter in-flow styling instead of floating-toast shadow, icons instead of a plain dot) in index.html/styles.css
